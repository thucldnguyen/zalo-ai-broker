...
class ZaloClient:
    ...
    def __init__(
        self, app_id: str, app_secret: str, access_token: Optional[str] = None
    ):
        """
    ...
    async def send_message(self, recipient_id: str, message: str) -> Dict[str, Any]:
        ...
        payload = {"recipient": {"user_id": recipient_id}, "message": {"text": message}}
    ...
    async def send_suggestions(
        self, recipient_id: str, text: str, suggestions: list
    ) -> Dict[str, Any]:
        """
    ...
    async def get_user_profile(self, user_id: str) -> Dict[str, Any]:
        ...
        params = {"access_token": self.access_token, "data": {"user_id": user_id}}
    ...
    def parse_webhook_message(payload: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.warning("Error parsing webhook: %s", e)
            return None
...
class ZaloAuthManager:
    ...
    def get_client_for_broker(
        self, broker_id: str, app_id: str, app_secret: str
    ) -> Optional[ZaloClient]:
        """
